# Generated by Django 3.2 on 2023-02-13 13:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('inprogress', 'inprogress'), ('completed', 'completed')], max_length=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=utils.generate_code.generate_code, max_length=8)),
                ('status', models.CharField(choices=[('received', 'received'), ('processed', 'processed'), ('shiped', 'shiped'), ('delivered', 'delivered')], max_length=18)),
